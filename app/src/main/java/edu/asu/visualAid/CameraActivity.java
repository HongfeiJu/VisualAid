...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private Intent gestureServiceIntent, falshSupportServiceIntent;
  ...
  private void fetchLocation() {
    Log.i("Hongfei_lw", "fetch location");
    if (ContextCompat.checkSelfPermission(CameraActivity.this,
      ...
      Log.i("Hongfei_lw", "get permission");
      fusedLocationClient.getLastLocation()
              .addOnSuccessListener(CameraActivity.this, location -> {
                if (location != null) {
                  ...
                  Log.i("Hongfei_lw", "null location");
                }
              });
    }
